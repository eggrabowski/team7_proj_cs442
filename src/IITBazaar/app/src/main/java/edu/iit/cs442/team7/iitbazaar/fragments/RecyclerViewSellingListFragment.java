 ...
 */
public class RecyclerViewSellingListFragment extends Fragment {
    private static final String TAG = "RecyclerViewSellingListFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new ItemAdapter(parentActivity, mCursor, MenuKeys.SELL);
        // Set ItemAdapter as the adapter for RecyclerView.
        mRecyclerView.setAdapter(mAdapter);
        // END_INCLUDE(initializeRecyclerView)

        DBController controller = IITBazaar.getDBController();
        parentActivity.registerSellDataChangeListeners(mAdapter);
        //this is an asynchronous callback
        controller.getSellItem(IITBazaar.getCurrentUser().getEmail(), parentActivity);
